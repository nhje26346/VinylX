...
namespace VinylX.Controllers
{
    ...
    public class MediaController : Controller
    {
        ...
        public MediaController(VinylXContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MediaID,MediaName")] Media media)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MediaID,MediaName")] Media media)
        {
            if (id != media.MediaID)
            {
                return NotFound();
